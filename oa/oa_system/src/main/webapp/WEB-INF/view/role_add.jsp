...
<article class="page-container">
	<form action="" method="post" class="form form-horizontal" id="roleForm">
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9">
			 <textarea  style="text-align: left;"  class="textarea" name="remark"  id="remark"  placeholder="说点什么...最少输入10个字符"  maxlength="200" >${role.remark}</textarea>
			</div>
		</div>
		<div class="row cl">
...
function role_Add(){
	...
	//使用ajax进行用户数据更新
	$.post("${ctx}/role/addRole.do",formData,function(result){
		if(result.code==1){
			//弹框
