				...
				<table width="80%" align="center">
					...
					<tr>
						<td align="center">作者: ${news.nauthor }&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
							类型： <a href="${pageContext.request.contextPath}/NewsServlet?action=listNews&tid=${news.ntid }">${news.tname}</a>
						</td>
					...
					<table width="80%" align="center">
						...
						<tr>
							...
							<td><input id="cauthor" name="cauthor" value="这家伙很懒什么也没留下" />
								IP： <input id="cip" value="${cip}" readonly="readonly" /></td>
						</tr>
						<tr>
							<td colspan="2"><textarea id="ccontent" cols="70"
									rows="10"></textarea></td>
						</tr>
						<td >
						<input name="submit" value="发  表" type="button" onclick="doAjaxComment()"/>
						</td>
					</table>
				</form>
			</ul>
